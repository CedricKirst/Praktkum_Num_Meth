...
figure('Name', 'Fehlerbetrachtung Finite Differenzen bei x0 = 0.6');
...
zp = abs(80/729-zp);
dpep = abs(80/729- dpep);
dpmp = abs(80/729- dpmp);
fpmp = abs(80/729- fpmp);

figure('Name', 'Fehlerbetrachtung Finite Differenzen bei x0 = 2.0');
